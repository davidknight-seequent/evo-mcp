...
class EvoContext:
    ...
    def __init__(self):
        ...
        # Use EVO_MCP_STATE_DIR if set, otherwise use .cache in repo root (for backwards compatibility)
        state_dir_env = os.getenv("EVO_MCP_STATE_DIR")
        if state_dir_env:
            self.cache_path = Path(state_dir_env)
        else:
    ...
    async def initialize(self):
        ...
        token_cache_path = self.cache_path / "token_cache.json"
        ...
        if authorizer is None:
            ...
            try:
                ...
                if auth_header.startswith('Bearer '):
                    ...
                    pass  # Token caching is optional, don't fail if it doesn't work
            except Exception as e:
